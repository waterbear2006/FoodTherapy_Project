...
/* 答题模式样式 */
.quiz-btn {
  background: linear-gradient(135deg, #e8dcc8 0%, #c4b494 100%);
  color: #fff;
  border-color: transparent;
}

.quiz-btn.active {
  background: linear-gradient(135deg, #c4b494 0%, #e8dcc8 100%);
  box-shadow: 0 4px 15px rgba(196, 180, 148, 0.4);
  color: #fff;
}
...
.ingredient-tag {
  ...
  user-select: none;
  transition: all 0.3s ease;
  box-shadow: 0 2px 8px rgba(196, 180, 148, 0.4);
}

.ingredient-tag:hover {
  transform: translateY(-2px);
  box-shadow: 0 4px 12px rgba(196, 180, 148, 0.5);
}
