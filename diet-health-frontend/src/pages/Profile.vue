    ...
    <section class="checkin-section">
      <div class="checkin-card" @click="router.push('/checkin')">
        ...
        <div class="checkin-info">
          <h3 class="checkin-title">每日打卡</h3>
          <p class="checkin-desc">坚持好习惯，健康每一天</p>
        </div>
...
.checkin-card {
  ...
  align-items: center;
  gap: 14px;
  background: rgba(246, 248, 246, 0.6);
  backdrop-filter: blur(20px);
  -webkit-backdrop-filter: blur(20px);
  border-radius: var(--radius-lg);
  padding: 16px 20px;
  border: 1px solid rgba(255, 255, 255, 0.5);
  box-shadow: 0 8px 32px rgba(125, 157, 138, 0.12), 0 2px 8px rgba(0, 0, 0, 0.04);
  cursor: pointer;
...
.checkin-icon {
  width: 40px;
  height: 40px;
  background: rgba(125, 157, 138, 0.15);
  border-radius: 10px;
  display: flex;
  align-items: center;
  justify-content: center;
